...
This Terms of Service Agreement (the "Agreement") is entered into between some_amoeba ("Bot Owner") and the user ("User") of the TroutBot Discord bot (the "Bot").
...
8. Governing Law: This Agreement shall be governed by and construed in accordance with the laws of Washington State.
